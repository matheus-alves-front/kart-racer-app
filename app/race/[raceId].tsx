...
import { RacerProfilesMock } from "@/@types/mock";
...
export default function RaceIdPage() {
  ...
  // const addRacerProfileSubmit = async () => {
  //   const scheduleResponse = await fetchInstanceWithToken(`/${trackId}/races/${race.id}/${profileId}`, {
  //     method: 'POST'
  //   })
  // }
